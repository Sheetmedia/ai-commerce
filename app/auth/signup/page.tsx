    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 px-4 py-12">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Bắt đầu với AI Commerce miễn phí</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg">
            <p className="text-sm font-semibold text-gray-900 mb-2">Miễn phí mãi mãi:</p>
            <ul className="space-y-1 text-sm text-gray-700">
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span> Track 5 sản phẩm
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span> 10 AI queries/ngày
              </li>
              <li className="flex items-center gap-2">
                <span className="text-green-500">✓</span> Insights cơ bản
              </li>
            </ul>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {password.length > 0 && (
                <div className="mt-2">
                  ...
                  <p className="text-xs text-gray-500">
                    Ít nhất 6 ký tự. Nên dùng chữ hoa, số và ký tự đặc biệt.
                  </p>
                </div>
              )}
            </div>
            ...
            <button
              ...
              className="w-full py-3 px-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-lg hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
